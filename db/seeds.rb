...
companies_data.each do |company_data|
  ...
  cover_list = ["db/images/image_1.png", "db/images/image_2.png", "db/images/image_3.png"]
  new_company.cover.attach(io: File.open(cover_list.sample), filename: "company_cover")
...
main_games_data.each do |game|
  ...
  cover_list = ["db/images/borderlands.png", "db/images/the_last_of_us.png", "db/images/tomb_raider.png"]
  new_game.cover.attach(io: File.open(cover_list.sample), filename: "game_cover")
